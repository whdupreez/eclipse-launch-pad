 ...
 *
 */
public class LaunchModeComparator implements Comparator<ILaunchMode> {

	private NullSafeComparator<String> nullSafe;

	public LaunchModeComparator() {
		this.nullSafe = Comparators.nullSafeStringComparator();
	}

	@Override
	public int compare(ILaunchMode o1, ILaunchMode o2) {
		Assert.notNull(o1, "Configuration element cannot be null.");
		Assert.notNull(o2, "Configuration element cannot be null.");

		String o1Mode = o1.getIdentifier();
		String o2Mode = o2.getIdentifier();
