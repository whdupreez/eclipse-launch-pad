 ...
 *     Willy du Preez - made available for the extended launcher plugin
 *******************************************************************************/
...
public abstract class AbstractCheckboxSelectionDialog extends AbstractSelectionDialog {
	...
	protected void addCustomFooterControls(Composite parent) {
		if (fShowSelectButtons){
			...
			Button button = SWTFactory.createPushButton(comp, Messages.checkbox_selection_dialog_select_all_btn, null);
			...
			button = SWTFactory.createPushButton(comp, Messages.checkbox_selection_dialog_deselect_all_btn, null);
			button.addSelectionListener(new SelectionAdapter() {
				@Override
				public void widgetSelected(SelectionEvent e) {
